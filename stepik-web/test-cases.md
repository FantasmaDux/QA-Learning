...
<details><summary><h3 style="display: inline; "> 2. Тест-кейс скорости доступа страницы при различной скорости соединения (Charles Throttling)</h3></summary>

**Идентификатор**: TCNW1

**Приоритет**: низкий

**Название**: скорость загрузки главной страницы при 64 kbps, 100 Mbps

Номер шага | Шаг | Ожидаемый результат| 
|-------------|-------------|----------------------------|
| 1 | Выставить в Charles Throttling скорость 64 kbps | Настройки сохранены |
| 2 | Выполнить запрос доступа к stepik.org | Статические ресурсы грузились от 1 до 12 с, главная страница HTML 7.2 с |
| 3 | Выставить в Charles Throttling скорость 100 Mbps | Настройки сохранены |
| 4 | Выполнить запрос доступа к stepik.org | Статические ресурсы грузились от 20 до 60 мс, главная страница HTML 341 мс |

**Приложение**:


<p align="center">
  <img  src="./screenshoots/tcnw1-0.png">
    <br>
  <em>Скорость ответа при 64 kbps замедлилась до 7 секунд. </em>
</p>

<p align="center">
  <img  src="./screenshoots/tcnw1-1.png">
      <br>
  <em>Скорость ответа при 100 Mbps составляет менее секунды.  </em>
</p>
</details>
