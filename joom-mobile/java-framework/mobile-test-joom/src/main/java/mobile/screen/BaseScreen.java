...
public class BaseScreen {
    ...
    public void scrollToTop() {
        ...
        int startY = (int) (size.height * 0.8); // почти низ

        int endY = (int) (size.height * 0.2); // почти верх
        ...
        for (int i = 0; i < 4; i++) {
            ...
            swipe.addAction(
                    finger.createPointerMove(Duration.ofMillis(500), PointerInput.Origin.viewport(),
                            startX, endY)
            );
